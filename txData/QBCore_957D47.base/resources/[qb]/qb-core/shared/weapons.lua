...
QBShared.Weapons = {
    ...
    [`weapon_glock43`]                = { name = 'weapon_glock43', label = 'Glock-43', weapontype = 'Pistol', ammotype = 'AMMO_PISTOL', damagereason = 'Pistoled / Blasted / Plugged / Bust a cap in' },
    [`weapon_msbs`]                   = { name = 'weapon_msbs', label = 'msbs', weapontype = 'Assault Rifle', ammotype = 'AMMO_RIFLE', damagereason = 'Ended / Rifled / Shot down / Floored' },
	[`weapon_300blkout`]               = { name = 'weapon_300blkout', label = '300blkout', weapontype = 'Submachine Gun', ammotype = 'AMMO_SMG', damagereason = 'Riddled / Drilled / Finished / Submachine Gunned' },
